...
router.get('/planilla', auth_middleware_1.protect, (0, validate_1.validateQuery)(asistencia_cuartelero_dto_1.planillaAsistenciaQueryDto), asistencia_cuarteleros_controller_1.getPlanillaAsistencia);
...
router.post('/celda', auth_middleware_1.protect, rolesGestion, (0, validate_1.validate)(asistencia_cuartelero_dto_1.upsertCeldaAsistenciaDto), asistencia_cuarteleros_controller_1.postCeldaAsistencia);
