...
exports.getCuadroHonorReporte = void 0;
...
const getCuadroHonorReporte = async (anioParam, mesParam) => {
    ...
    const parteVigenteMes = (0, partes_where_1.parteWhereNoAnulado)({
        fechaEmergencia: { gte: inicioMes, lte: finMes },
    });
    const parteVigenteAnio = (0, partes_where_1.parteWhereNoAnulado)({
        fechaEmergencia: { gte: inicioAnio, lte: finAnio },
    });
    const parteVigenteQuincena = (0, partes_where_1.parteWhereNoAnulado)({
    ...
    const [asistenciasMes, asistenciasAnio, asistenciasQuincena] = await Promise.all([
        prisma_1.default.asistenciaPersonal.findMany({
...
exports.getCuadroHonorReporte = getCuadroHonorReporte;
