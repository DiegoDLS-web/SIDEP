...
const inventario_dto_1 = require("../../logistica/dtos/inventario.dto");
...
router.get('/export/excel', (0, validate_1.validateQuery)(inventario_dto_1.filtrosPartesExportQueryDto), partes_controller_1.exportarPartesExcel);
router.get('/export/pdf', (0, validate_1.validateQuery)(inventario_dto_1.filtrosPartesExportQueryDto), partes_controller_1.exportarPartesPdf);
...
router.get('/:id/analitica', partes_controller_1.obtenerAnaliticaParte);
