...
import type { InventarioItemDto } from '../../modules/logistica/services/inventario-items.service';
...
function ubicacionItem(f: InventarioItemDto): string {
...
function filaItem(f: InventarioItemDto): (string | number)[] {
  return [
    f.codigo,
    f.nombre,
    f.talla ?? '—',
