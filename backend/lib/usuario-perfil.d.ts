...
export declare const CARGOS_OFICIALIDAD: readonly ["VOLUNTARIO", "DIRECTOR_COMPANIA", "SECRETARIO_COMPANIA", "TESORERO_COMPANIA", "PRO_SECRETARIO_COMPANIA", "CAPITAN_COMPANIA", "TENIENTE_PRIMERO", "TENIENTE_SEGUNDO", "TENIENTE_TERCERO", "TENIENTE_CUARTO", "AYUDANTE_COMPANIA", "PRO_AYUDANTE", "SUPERINTENDENTE", "VICE_SUPERINTENDENTE", "SECRETARIO_GENERAL", "TESORERO_GENERAL", "PRIMER_COMANDANTE", "SEGUNDO_COMANDANTE", "INSPECTOR_COMANDANCIA_1", "INSPECTOR_COMANDANCIA_2", "INSPECTOR_MATERIAL_MAYOR", "AYUDANTE_COMANDANTE", "INSPECTOR_COMUNICACIONES", "SEGUNDO_AYUDANTE", "OFICIAL_MAQUINAS", "INTENDENTE_CUARTEL", "INTENDENTE"];
...
export declare function normalizarFotoPerfil(raw: string | undefined | null): string | null;
