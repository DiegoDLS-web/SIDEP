/** Catálogo inicial (debe coincidir con `partes.constants.ts` sin la opción `todos`). */
export type TipoEmergenciaItem = { value: string; label: string };

export function defaultTiposEmergencia(): TipoEmergenciaItem[] {
  return [
