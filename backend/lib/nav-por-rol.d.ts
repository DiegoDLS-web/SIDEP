 ...
 */
export declare const RUTAS_MENU_SIDEP: readonly ["/", "/partes", "/catalogo-emergencias", "/carros", "/checklist", "/checklist-era", "/bolso-trauma", "/licencias-medicas", "/analitica-operacional", "/usuarios", "/configuraciones", "/perfil"];
