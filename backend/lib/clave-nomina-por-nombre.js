...
exports.CLAVE_NOMINA_POR_NOMBRE_SEED = void 0;
exports.normalizarNombreParaClave = normalizarNombreParaClave;
exports.claveNominaParaNombreCompleto = claveNominaParaNombreCompleto;
/**
 ...
 */
function normalizarNombreParaClave(n) {
    return n
        .normalize('NFD')
        .replace(/[\u0300-\u036f]/g, '')
        .replace(/\s+/g, ' ')
...
function claveNominaParaNombreCompleto(nombre) {
    const k = nombre?.trim();
    if (!k)
        return null;
...
exports.CLAVE_NOMINA_POR_NOMBRE_SEED = CLAVE_RAW;
//# sourceMappingURL=clave-nomina-por-nombre.js.map